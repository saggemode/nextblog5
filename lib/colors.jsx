...
function getRandomPairOfColors() {
    ...
    var getRandomIdx = function () { return random(0, colors.length - 1); };
...
exports.getRandomPairOfColors = getRandomPairOfColors;
...
function isDark(color) {
    ...
    var rgb = exports.colorMap[color] ? hexToRgb(exports.colorMap[color]) : hexToRgb(color);
